...
// Custom Product Tabs
add_filter( 'woocommerce_product_tabs', 'flatsome_custom_product_tabs_plus' );
function flatsome_custom_product_tabs_plus( $tabs ) {
  global $wc_cpdf;
...
function flatsome_custom_tab_content_2() {
  // The new tab content
  global $wc_cpdf;
  echo do_shortcode($wc_cpdf->get_value(get_the_ID(), '_custom_tab_2'));
}
function flatsome_custom_tab_content_3() {
  // The new tab content
  global $wc_cpdf;
  echo do_shortcode($wc_cpdf->get_value(get_the_ID(), '_custom_tab_3'));
}
function flatsome_custom_tab_content_4() {
  // The new tab content
  global $wc_cpdf;
  echo do_shortcode($wc_cpdf->get_value(get_the_ID(), '_custom_tab_4'));
}