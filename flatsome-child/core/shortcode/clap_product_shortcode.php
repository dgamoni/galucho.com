...
function clap_product_techdetails_shortcode( $atts ) {
	global $post;
	$clap_product_techdetails = $atts['url'];
	 if ( $clap_product_techdetails) : 
	 		//$output = '<a href="'.$clap_product_techdetails.'">Visualizar</a>';
	 		$output = '<div class="clap_product_techdetails"><img src="'.$clap_product_techdetails.'"></div>';
	 endif;
	 return $output;
}
